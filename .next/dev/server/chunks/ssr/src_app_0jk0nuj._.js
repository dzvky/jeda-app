...
function StreakHeatmap({ riwayat, isDarkMode }) {
    // Mengambil daftar tanggal unik dari riwayat catatan
    const setTanggalAktif = new Set(riwayat.map((item)=>item.rawDate || item.tanggal));
    // Menghasilkan 14 hari terakhir untuk ditampilkan sebagai visualisasi mini
    const generateHariTerakhir = ()=>{
        const listHari = [];
        for(let i = 13; i >= 0; i--){
            const d = new Date();
            d.setDate(d.getDate() - i);
            const rawString = d.toISOString().split('T')[0];
            const formattedString = d.toLocaleDateString('id-ID', {
                day: 'numeric',
                month: 'short',
                year: 'numeric'
            });
            const adaCatatan = setTanggalAktif.has(rawString) || setTanggalAktif.has(formattedString);
            listHari.push({
                tanggalStr: formattedString,
                adaCatatan
            });
        }
        return listHari;
    };
    const dataHari = generateHariTerakhir();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: `p-4 rounded-2xl border space-y-2.5 ${isDarkMode ? 'bg-black/20 border-[#7A8A76]/15' : 'bg-white/60 border-[#8A9A86]/15'}`,
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex justify-between items-center",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: `text-[10px] font-semibold uppercase tracking-wider block ${isDarkMode ? 'text-[#A2B59F]' : 'text-[#6E7D6A]'}`,
                        children: "🔥 Jejak 2 Minggu Terakhir"
                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex justify-between items-center gap-1 pt-1",
                children: dataHari.map((hari, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        title: `${hari.tanggalStr}: ${hari.adaCatatan ? 'Ada catatan refleksi' : 'Belum ada catatan'}`,
                        className: `h-7 flex-1 rounded-md transition-all ${hari.adaCatatan ? 'bg-[#7A8A76] shadow-2xs' : isDarkMode ? 'bg-white/5 border border-white/5' : 'bg-[#8A9A86]/10'}`
                    }, idx, false, {
                        fileName: "[project]/src/app/components/StreakHeatmap.tsx",
                        lineNumber: 46,
                        columnNumber: 11
...
const supabaseAnonKey = ("TURBOPACK compile-time value", "KUNCI_ANON_ANDA_DISINI") || '';
...
function Home() {
    ...
    // Ambil data dari Supabase saat aplikasi dimuat
    ...
    const handleHapusSemua = async ()=>{
        if (confirm("Apakah kamu yakin ingin menghapus seluruh jejak catatan di cloud?")) {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('catatan').delete().neq('id', 0); // Hapus semua baris
            if (error) {
            ...
            fileReader.onload = async (event)=>{
                try {
                    ...
                    if (Array.isArray(parsedData) && (parsedData.length === 0 || 'id' in parsedData[0] && 'teks' in parsedData[0])) {
                        // Masukkan data impor ke Supabase
...
//# sourceMappingURL=src_app_0jk0nuj._.js.map